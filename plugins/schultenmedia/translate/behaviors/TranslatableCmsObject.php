 ...
 *
 *   public $implement = ['@SchultenMedia.Translate.Behaviors.TranslatableCmsObject'];
 *
 *   public $translatable = ['title', 'markup'];
 *
 * This definition is optional and defaults to SchultenMedia\Translate\Classes\MLCmsObject
 *
 *   public $translatableModel = 'SchultenMedia\Translate\Classes\MLStaticPage';
 *
 */
class TranslatableCmsObject extends TranslatableBehavior
{
    ...
    public function getTranslatableModelClass()
    {
        ...
        return \SchultenMedia\Translate\Classes\MLCmsObject::class;
    }
}
