<?php namespace SchultenMedia\Translate;
...
use SchultenMedia\Translate\Classes\EventCoreRegistry;
use SchultenMedia\Translate\Classes\EventPluginRegistry;
...
class Plugin extends PluginBase
{
    ...
    public function pluginDetails()
    {
        return [
            ...
            'icon' => 'icon-language',
            'homepage' => 'https://github.com/schultenmedia/translate-plugin'
        ];
    }
    ...
    public function register()
    {
        ...
        $this->registerConsoleCommand('translate.scan', \SchultenMedia\Translate\Console\ScanCommand::class);
        $this->registerConsoleCommand('translate.migratev1', \SchultenMedia\Translate\Console\MigrateV1Command::class);
    ...
    public function boot()
    {
        ...
        if (class_exists('\SchultenMedia\Pages\Classes\SnippetManager')) {
            $handler = function ($controller, $template, $type) {
                ...
                if (!empty($dirtyLocales)) {
                    ...
                    foreach ($dirtyLocales as $locale) {
                        ...
                        // Clear the SchultenMedia.Pages caches for each dirty locale
                        App::setLocale($locale);
                        \SchultenMedia\Pages\Plugin::clearCache();
                    }
    ...
    {
        return [
            'schultenmedia.translate.manage_messages' => [
                'tab' => 'Translation',
    ...
    public function registerSettings()
    {
        return [
            'messages' => [
                ...
                'icon' => 'icon-list-alt',
                'url' => Backend::url('schultenmedia/translate/messages'),
                'order' => 551,
                'category' => SettingsManager::CATEGORY_CMS,
                'permissions' => ['schultenmedia.translate.manage_messages'],
                'keywords' => 'translate',
            ]
        ];
    }
    ...
    protected function registerAssetBundles()
    {
        CombineAssets::registerCallback(function ($combiner) {
            $combiner->registerBundle('$/schultenmedia/translate/assets/less/messages.less');
        });
    }
