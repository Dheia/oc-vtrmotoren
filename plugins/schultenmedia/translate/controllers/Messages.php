<?php namespace SchultenMedia\Translate\Controllers;

use Flash;
use BackendMenu;
use Backend\Classes\Controller;
use SchultenMedia\Translate\Models\Message;
use SchultenMedia\Translate\Classes\Locale;
...
class Messages extends Controller
{
     ...
     */
    public $requiredPermissions = ['schultenmedia.translate.manage_messages'];
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('SchultenMedia.Translate', 'messages');

        $this->addJs('/plugins/schultenmedia/translate/assets/js/messages.js');
        $this->addCss('/plugins/schultenmedia/translate/assets/css/messages.css');
    }
