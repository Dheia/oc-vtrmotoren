...
use SchultenMedia\Translate\Classes\Locale as LocaleModel;
...
class EventCoreRegistry
{
    ...
    protected function extendCmsPageObject()
    {
        Page::extend(function($model) {
            ...
            if (!$model->isClassExtendedWith(\SchultenMedia\Translate\Behaviors\TranslatablePageUrl::class)) {
                $model->extendClassWith(\SchultenMedia\Translate\Behaviors\TranslatablePageUrl::class);
            }

            if (!$model->isClassExtendedWith(\SchultenMedia\Translate\Behaviors\TranslatablePage::class)) {
                $model->extendClassWith(\SchultenMedia\Translate\Behaviors\TranslatablePage::class);
            }
        });
    }
    ...
    protected function extendCmsThemeDataModel()
    {
        Event::listen('cms.theme.createThemeDataModel', function($attributes) {
            return new \SchultenMedia\Translate\Models\MLThemeData($attributes);
        });
    }
    ...
    protected function extendBackendFormFields()
    {
        ...
        Event::listen('backend.form.extendFieldsBefore', function($widget) {
            ...
            if (
                !$model->isClassExtendedWith(\SchultenMedia\Translate\Behaviors\TranslatableModel::class) &&
                !$model->isClassExtendedWith(\SchultenMedia\Translate\Behaviors\TranslatablePage::class) &&
                !$model->isClassExtendedWith(\SchultenMedia\Translate\Behaviors\TranslatableCmsObject::class)
            ) {
                return;
            }
