...
class Translator
{
    ...
    const SESSION_LOCALE = 'schultenmedia.translate.locale';

    const SESSION_CONFIGURED = 'schultenmedia.translate.configured';
    ...
    public function isConfigured()
    {
        ...
        elseif (App::hasDatabase() && Schema::hasTable('sm_translate_locales')) {
    ...
    public function getPathInLocale($path, $locale = null, $prefixDefaultLocale = null)
    {
        $prefixDefaultLocale = (is_null($prefixDefaultLocale))
            ? Config::get('schultenmedia.translate::prefixDefaultLocale')
            : $prefixDefaultLocale;
