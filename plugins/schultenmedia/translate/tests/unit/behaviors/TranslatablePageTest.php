<?php namespace SchultenMedia\Translate\Tests\Unit\Behaviors;
...
use SchultenMedia\Translate\Tests\Fixtures\Classes\TranslatablePage;
...
class TranslatablePageTest extends PluginTestCase
{
    ...
    public function setUp(): void
    {
        ...
        TranslatablePage::extend(function($page) {
            if (!$page->isClassExtendedWith('SchultenMedia\Translate\Behaviors\TranslatablePage')) {
                $page->addDynamicProperty('translatable', ['title']);
                $page->extendClassWith('SchultenMedia\Translate\Behaviors\TranslatablePage');
            }
        });
