...
use SchultenMedia\FormBuilder\Models\Field;
...
class NativeFileUpload extends Migration
{
    public function up()
    {
        if (! Schema::hasColumn('sm_formbuilder_fields', 'has_multiple_files')) {
        ...
        if (! Schema::hasColumn('sm_formbuilder_fields', 'max_size')) {
            return;
        }
